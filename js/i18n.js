...
const STRINGS = {
  en: {
    ...
    'row.ext.warn': 'The file extension does not promise playback in Chrome — the exact reason shows when you try',
    ...
    'error.grant.denied': 'Chrome did not grant access',
    ...
    'probe.video': 'The video codec {codec} cannot be decoded in Chrome.',
    'probe.noaudio': 'The file has no audio track.',
    'probe.decoded': 'MKV: {video} + {audio} — the audio is decoded in the player.',
    'probe.silent': 'The audio track is {codec}, which Chrome does not decode. The picture would play, the sound would not.',
    'probe.remux': 'MKV: {video} + {audio} — the content suits Chrome, but the container is not unpacked.',
    ...
    'row.ext.warn': 'Pääte ei lupaa toistoa Chromessa — tarkka syy selviää toistoa yritettäessä',
    ...
    'error.grant.denied': 'Chrome ei myöntänyt oikeutta',
    ...
    'probe.video': 'Videokoodekkia {codec} ei voi purkaa Chromessa.',
    'probe.noaudio': 'Tiedostossa ei ole ääniraitaa.',
    'probe.decoded': 'MKV: {video} + {audio} — ääni puretaan soittimessa.',
    'probe.silent': 'Ääniraita on {codec}, jota Chrome ei pura. Kuva toistuisi, ääni ei.',
    'probe.remux': 'MKV: {video} + {audio} — sisältö kelpaa Chromelle, mutta kontin purku puuttuu.',
