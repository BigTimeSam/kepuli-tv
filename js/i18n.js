...
const STRINGS = {
  en: {
    ...
    'setup.tab.account': 'Account',
    'setup.instant': 'Changes take effect as you make them.',
    'setup.connect.note': 'Connecting again reloads the lists and takes the one connection your account allows.',
    'setup.connect.first': 'The address and credentials come from your provider. Nothing is sent anywhere else.',
    ...
    'setup.tab.general': 'Yleiset',
    'setup.tab.subs': 'Tekstitys',
    'setup.tab.connection': 'Yhteys',
    'setup.tab.account': 'Tili',
    'setup.instant': 'Muutokset tulevat voimaan heti.',
    'setup.connect.note': 'Uusi yhdistäminen lataa listat ja vie tilin ainoan sallitun yhteyden.',
    'setup.connect.first': 'Osoite ja tunnukset saat palveluntarjoajaltasi. Mitään ei lähetetä muualle.',
